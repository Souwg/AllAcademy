...
import paint from "../../img/painting.jpg";
        ...
        <div className="container mb-4">
          ...
          <div className="row">
            <div className="col-12 col-md-6 mb-3 mb-md-0">
              <div
                className="card border-0 bg-white overflow-hidden shadow-sm d-flex flex-column"
                style={{ transition: "transform 0.2s", borderRadius: "1rem" }}
              >
