    ...
    <>
          ...
          <div className="row">
            <div className="col-12">
              <p
                ...
                style={{
                  fontSize: "clamp(2.5rem, 8vw, 80px)", // Responsive: 2.5rem (móvil) → 80px (desktop)
                  fontWeight: "700",
                  lineHeight: "1.2", // Mejor espaciado en móviles
      ...
      >
        ...
        >
          <div
            className="row"
            style={{ position: "relative", marginTop: "-200px", zIndex: "3" }}
          >
